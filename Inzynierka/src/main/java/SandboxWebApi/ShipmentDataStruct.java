...
public class ShipmentDataStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.ShipmentTimeStruct shipmentTime;
    ...
    public ShipmentDataStruct(
           ...
           int shipmentType,
           SandboxWebApi.ShipmentTimeStruct shipmentTime) {
     ...
     * @return shipmentTime
     */
    public SandboxWebApi.ShipmentTimeStruct getShipmentTime() {
        return shipmentTime;
    }
     ...
     * @param shipmentTime
     */
    public void setShipmentTime(SandboxWebApi.ShipmentTimeStruct shipmentTime) {
        this.shipmentTime = shipmentTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ShipmentDataStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentTime");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ShipmentTimeStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
