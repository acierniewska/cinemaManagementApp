...
public class MessageToBuyerStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "MessageToBuyerStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("messageSellerId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "messageSellerId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("messageContent");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "messageContent"));
