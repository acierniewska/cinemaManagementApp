...
public class SellRatingInfoStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellRatingReasonStruct[] sellRatingReasons;
    ...
    public SellRatingInfoStruct(
           ...
           SandboxWebApi.SellRatingReasonStruct[] sellRatingReasons) {
     ...
     */
    public SandboxWebApi.SellRatingReasonStruct[] getSellRatingReasons() {
        return sellRatingReasons;
    }
     ...
     */
    public void setSellRatingReasons(SandboxWebApi.SellRatingReasonStruct[] sellRatingReasons) {
        this.sellRatingReasons = sellRatingReasons;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingInfoStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingGroupId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingGroupId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingGroupTitle");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingGroupTitle"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingReasons");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingReasons"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingReasonStruct"));
