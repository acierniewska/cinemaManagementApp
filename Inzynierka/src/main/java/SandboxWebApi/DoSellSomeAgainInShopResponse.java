...
public class DoSellSomeAgainInShopResponse  implements java.io.Serializable {
    private SandboxWebApi.StructSellAgain[] itemsSellAgain;

    private SandboxWebApi.StructSellFailed[] itemsSellFailed;
    ...
    public DoSellSomeAgainInShopResponse(
           SandboxWebApi.StructSellAgain[] itemsSellAgain,
           SandboxWebApi.StructSellFailed[] itemsSellFailed,
     ...
     */
    public SandboxWebApi.StructSellAgain[] getItemsSellAgain() {
        return itemsSellAgain;
    }
     ...
     */
    public void setItemsSellAgain(SandboxWebApi.StructSellAgain[] itemsSellAgain) {
        this.itemsSellAgain = itemsSellAgain;
    }
     ...
     */
    public SandboxWebApi.StructSellFailed[] getItemsSellFailed() {
        return itemsSellFailed;
    }
     ...
     */
    public void setItemsSellFailed(SandboxWebApi.StructSellFailed[] itemsSellFailed) {
        this.itemsSellFailed = itemsSellFailed;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doSellSomeAgainInShopResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemsSellAgain");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemsSellAgain"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "StructSellAgain"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemsSellFailed"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "StructSellFailed"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemsSellNotFound"));
