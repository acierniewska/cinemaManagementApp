...
public class VariantStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.VariantQuantityStruct[] quantities;
    ...
    public VariantStruct(
           int fid,
           SandboxWebApi.VariantQuantityStruct[] quantities) {
           this.fid = fid;
     ...
     * @return quantities
     */
    public SandboxWebApi.VariantQuantityStruct[] getQuantities() {
        return quantities;
    }
     ...
     * @param quantities
     */
    public void setQuantities(SandboxWebApi.VariantQuantityStruct[] quantities) {
        this.quantities = quantities;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "VariantStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "quantities"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "VariantQuantityStruct"));
