...
public class DoAddPackageInfoToPostBuyFormResponse  implements java.io.Serializable {
    private SandboxWebApi.PostBuyFormPackageInfoStruct postBuyFormPackageInfo;

    public DoAddPackageInfoToPostBuyFormResponse() {
    }

    public DoAddPackageInfoToPostBuyFormResponse(
           SandboxWebApi.PostBuyFormPackageInfoStruct postBuyFormPackageInfo) {
     ...
     */
    public SandboxWebApi.PostBuyFormPackageInfoStruct getPostBuyFormPackageInfo() {
        return postBuyFormPackageInfo;
    }
     ...
     */
    public void setPostBuyFormPackageInfo(SandboxWebApi.PostBuyFormPackageInfoStruct postBuyFormPackageInfo) {
        this.postBuyFormPackageInfo = postBuyFormPackageInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doAddPackageInfoToPostBuyFormResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("postBuyFormPackageInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "postBuyFormPackageInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PostBuyFormPackageInfoStruct"));
