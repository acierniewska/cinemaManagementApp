...
public class DoAddToWatchListResponse  implements java.io.Serializable {
    private SandboxWebApi.WatchListInfoStruct watchListInfo;

    public DoAddToWatchListResponse() {
    }

    public DoAddToWatchListResponse(
           SandboxWebApi.WatchListInfoStruct watchListInfo) {
     ...
     */
    public SandboxWebApi.WatchListInfoStruct getWatchListInfo() {
        return watchListInfo;
    }
     ...
     * @param watchListInfo
     */
    public void setWatchListInfo(SandboxWebApi.WatchListInfoStruct watchListInfo) {
        this.watchListInfo = watchListInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doAddToWatchListResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("watchListInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "watchListInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "WatchListInfoStruct"));
