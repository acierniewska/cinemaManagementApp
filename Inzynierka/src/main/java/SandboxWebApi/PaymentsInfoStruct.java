...
public class PaymentsInfoStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.PaymentsUserDataStruct paymentsUserData;

    private SandboxWebApi.PaymentsPayoutStruct paymentsPayout;
    ...
    public PaymentsInfoStruct(
           ...
           SandboxWebApi.PaymentsUserDataStruct paymentsUserData,
           SandboxWebApi.PaymentsPayoutStruct paymentsPayout,
     ...
     */
    public SandboxWebApi.PaymentsUserDataStruct getPaymentsUserData() {
        return paymentsUserData;
    }
     ...
     */
    public void setPaymentsUserData(SandboxWebApi.PaymentsUserDataStruct paymentsUserData) {
        this.paymentsUserData = paymentsUserData;
    }
     ...
     */
    public SandboxWebApi.PaymentsPayoutStruct getPaymentsPayout() {
        return paymentsPayout;
    }
     ...
     */
    public void setPaymentsPayout(SandboxWebApi.PaymentsPayoutStruct paymentsPayout) {
        this.paymentsPayout = paymentsPayout;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentsInfoStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentsBalance");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentsBalance"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "float"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentsBankAccount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentsBankAccount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentsUserData");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentsUserData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentsUserDataStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentsPayout");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentsPayout"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentsPayoutStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentsNotifications");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentsNotifications"));
