...
public class DoGetMyNotSoldItemsResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.NotSoldItemStruct[] notSoldItemsList;
    ...
    public DoGetMyNotSoldItemsResponse(
           ...
           SandboxWebApi.NotSoldItemStruct[] notSoldItemsList) {
     ...
     */
    public SandboxWebApi.NotSoldItemStruct[] getNotSoldItemsList() {
        return notSoldItemsList;
    }
     ...
     */
    public void setNotSoldItemsList(SandboxWebApi.NotSoldItemStruct[] notSoldItemsList) {
        this.notSoldItemsList = notSoldItemsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyNotSoldItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("notSoldItemsCounter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "notSoldItemsCounter"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("notSoldItemsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "notSoldItemsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "NotSoldItemStruct"));
