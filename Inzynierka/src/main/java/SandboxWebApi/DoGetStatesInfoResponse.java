...
public class DoGetStatesInfoResponse  implements java.io.Serializable {
    private SandboxWebApi.StateInfoStruct[] statesInfoArray;

    public DoGetStatesInfoResponse() {
    }

    public DoGetStatesInfoResponse(
           SandboxWebApi.StateInfoStruct[] statesInfoArray) {
     ...
     */
    public SandboxWebApi.StateInfoStruct[] getStatesInfoArray() {
        return statesInfoArray;
    }
     ...
     */
    public void setStatesInfoArray(SandboxWebApi.StateInfoStruct[] statesInfoArray) {
        this.statesInfoArray = statesInfoArray;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetStatesInfoResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statesInfoArray");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "statesInfoArray"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "StateInfoStruct"));
