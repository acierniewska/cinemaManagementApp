...
public class BidListStruct2  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "BidListStruct2"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bidsArray");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "bidsArray"));
