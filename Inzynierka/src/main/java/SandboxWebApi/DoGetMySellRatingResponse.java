...
public class DoGetMySellRatingResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellRatingAverageStruct[] sellRatingAverage;

    private SandboxWebApi.SellRatingDetailStruct[] sellRatingDetails;

    private SandboxWebApi.SellRatingAveragePerMonthStruct[] sellRatingStatsPerMonth;
    ...
    public DoGetMySellRatingResponse(
           ...
           SandboxWebApi.SellRatingAverageStruct[] sellRatingAverage,
           SandboxWebApi.SellRatingDetailStruct[] sellRatingDetails,
           SandboxWebApi.SellRatingAveragePerMonthStruct[] sellRatingStatsPerMonth) {
     ...
     */
    public SandboxWebApi.SellRatingAverageStruct[] getSellRatingAverage() {
        return sellRatingAverage;
    }
     ...
     */
    public void setSellRatingAverage(SandboxWebApi.SellRatingAverageStruct[] sellRatingAverage) {
        this.sellRatingAverage = sellRatingAverage;
    }
     ...
     */
    public SandboxWebApi.SellRatingDetailStruct[] getSellRatingDetails() {
        return sellRatingDetails;
    }
     ...
     */
    public void setSellRatingDetails(SandboxWebApi.SellRatingDetailStruct[] sellRatingDetails) {
        this.sellRatingDetails = sellRatingDetails;
    }
     ...
     */
    public SandboxWebApi.SellRatingAveragePerMonthStruct[] getSellRatingStatsPerMonth() {
        return sellRatingStatsPerMonth;
    }
     ...
     */
    public void setSellRatingStatsPerMonth(SandboxWebApi.SellRatingAveragePerMonthStruct[] sellRatingStatsPerMonth) {
        this.sellRatingStatsPerMonth = sellRatingStatsPerMonth;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMySellRatingResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingTotalCount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingTotalCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingAverage");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingAverage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingDetailStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingStatsPerMonth"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingAveragePerMonthStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
