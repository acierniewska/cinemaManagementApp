...
public class SellRatingDetailStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellRatingReasonSumStruct[] sellRatingReasonsSummary;
    ...
    public SellRatingDetailStruct(
           ...
           SandboxWebApi.SellRatingReasonSumStruct[] sellRatingReasonsSummary) {
     ...
     */
    public SandboxWebApi.SellRatingReasonSumStruct[] getSellRatingReasonsSummary() {
        return sellRatingReasonsSummary;
    }
     ...
     */
    public void setSellRatingReasonsSummary(SandboxWebApi.SellRatingReasonSumStruct[] sellRatingReasonsSummary) {
        this.sellRatingReasonsSummary = sellRatingReasonsSummary;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingDetailStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingReasonsSummary"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingReasonSumStruct"));
