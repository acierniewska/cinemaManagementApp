...
public class ItemSurchargeStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.AmountStruct surchargeAmount;
    ...
    public ItemSurchargeStruct(
           ...
           SandboxWebApi.AmountStruct surchargeAmount) {
     ...
     */
    public SandboxWebApi.AmountStruct getSurchargeAmount() {
        return surchargeAmount;
    }
     ...
     */
    public void setSurchargeAmount(SandboxWebApi.AmountStruct surchargeAmount) {
        this.surchargeAmount = surchargeAmount;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemSurchargeStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("surchargeDescription");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "surchargeDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("surchargeAmount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "surchargeAmount"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "AmountStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
