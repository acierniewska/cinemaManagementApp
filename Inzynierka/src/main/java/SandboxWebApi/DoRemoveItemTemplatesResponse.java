...
public class DoRemoveItemTemplatesResponse  implements java.io.Serializable {
    private SandboxWebApi.RemovedItemTemplatesStruct removedItemTemplates;

    public DoRemoveItemTemplatesResponse() {
    }

    public DoRemoveItemTemplatesResponse(
           SandboxWebApi.RemovedItemTemplatesStruct removedItemTemplates) {
     ...
     */
    public SandboxWebApi.RemovedItemTemplatesStruct getRemovedItemTemplates() {
        return removedItemTemplates;
    }
     ...
     */
    public void setRemovedItemTemplates(SandboxWebApi.RemovedItemTemplatesStruct removedItemTemplates) {
        this.removedItemTemplates = removedItemTemplates;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doRemoveItemTemplatesResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("removedItemTemplates");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "removedItemTemplates"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RemovedItemTemplatesStruct"));
