...
public class DoCheckItemDescriptionResponse  implements java.io.Serializable {
    private SandboxWebApi.ItemDescriptionStruct itemDescription;

    public DoCheckItemDescriptionResponse() {
    }

    public DoCheckItemDescriptionResponse(
           SandboxWebApi.ItemDescriptionStruct itemDescription) {
     ...
     */
    public SandboxWebApi.ItemDescriptionStruct getItemDescription() {
        return itemDescription;
    }
     ...
     */
    public void setItemDescription(SandboxWebApi.ItemDescriptionStruct itemDescription) {
        this.itemDescription = itemDescription;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doCheckItemDescriptionResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemDescription");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemDescriptionStruct"));
