...
public class DoGetRefundsListResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.RefundListType[] refundsList;
    ...
    public DoGetRefundsListResponse(
           int refundsCount,
           SandboxWebApi.RefundListType[] refundsList,
     ...
     * @return refundsList
     */
    public SandboxWebApi.RefundListType[] getRefundsList() {
        return refundsList;
    }
     ...
     * @param refundsList
     */
    public void setRefundsList(SandboxWebApi.RefundListType[] refundsList) {
        this.refundsList = refundsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetRefundsListResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("refundsCount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "refundsCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("refundsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "refundsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RefundListType"));
