...
public class DoMyBillingItemResponse  implements java.io.Serializable {
    private SandboxWebApi.ItemBilling[] entryFees;

    private SandboxWebApi.ItemBilling[] endingFees;

    public DoMyBillingItemResponse() {
    }

    public DoMyBillingItemResponse(
           SandboxWebApi.ItemBilling[] entryFees,
           SandboxWebApi.ItemBilling[] endingFees) {
     ...
     * @return entryFees
     */
    public SandboxWebApi.ItemBilling[] getEntryFees() {
        return entryFees;
    }
     ...
     * @param entryFees
     */
    public void setEntryFees(SandboxWebApi.ItemBilling[] entryFees) {
        this.entryFees = entryFees;
    }
     ...
     * @return endingFees
     */
    public SandboxWebApi.ItemBilling[] getEndingFees() {
        return endingFees;
    }
     ...
     * @param endingFees
     */
    public void setEndingFees(SandboxWebApi.ItemBilling[] endingFees) {
        this.endingFees = endingFees;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doMyBillingItemResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entryFees");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "entryFees"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemBilling"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "endingFees"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemBilling"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
