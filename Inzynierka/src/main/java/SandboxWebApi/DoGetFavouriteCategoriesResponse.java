...
public class DoGetFavouriteCategoriesResponse  implements java.io.Serializable {
    private SandboxWebApi.FavouritesCategoriesStruct[] sFavouriteCategoriesList;

    public DoGetFavouriteCategoriesResponse() {
    }

    public DoGetFavouriteCategoriesResponse(
           SandboxWebApi.FavouritesCategoriesStruct[] sFavouriteCategoriesList) {
     ...
     */
    public SandboxWebApi.FavouritesCategoriesStruct[] getSFavouriteCategoriesList() {
        return sFavouriteCategoriesList;
    }
     ...
     */
    public void setSFavouriteCategoriesList(SandboxWebApi.FavouritesCategoriesStruct[] sFavouriteCategoriesList) {
        this.sFavouriteCategoriesList = sFavouriteCategoriesList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetFavouriteCategoriesResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("SFavouriteCategoriesList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sFavouriteCategoriesList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FavouritesCategoriesStruct"));
