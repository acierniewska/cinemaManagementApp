...
public class DoAddToBlackListRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.UserBlackListStruct[] usersBlackListArray;
    ...
    public DoAddToBlackListRequest(
           ...
           SandboxWebApi.UserBlackListStruct[] usersBlackListArray) {
     ...
     */
    public SandboxWebApi.UserBlackListStruct[] getUsersBlackListArray() {
        return usersBlackListArray;
    }
     ...
     */
    public void setUsersBlackListArray(SandboxWebApi.UserBlackListStruct[] usersBlackListArray) {
        this.usersBlackListArray = usersBlackListArray;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoAddToBlackListRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "usersBlackListArray"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserBlackListStruct"));
