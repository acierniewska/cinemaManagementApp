...
public class ChangedItemStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.FieldsValue[] itemFields;

    private SandboxWebApi.ItemSurchargeStruct[] itemSurcharge;
    ...
    public ChangedItemStruct(
           long itemId,
           SandboxWebApi.FieldsValue[] itemFields,
           SandboxWebApi.ItemSurchargeStruct[] itemSurcharge) {
           this.itemId = itemId;
     ...
     * @return itemFields
     */
    public SandboxWebApi.FieldsValue[] getItemFields() {
        return itemFields;
    }
     ...
     * @param itemFields
     */
    public void setItemFields(SandboxWebApi.FieldsValue[] itemFields) {
        this.itemFields = itemFields;
    }
     ...
     */
    public SandboxWebApi.ItemSurchargeStruct[] getItemSurcharge() {
        return itemSurcharge;
    }
     ...
     * @param itemSurcharge
     */
    public void setItemSurcharge(SandboxWebApi.ItemSurchargeStruct[] itemSurcharge) {
        this.itemSurcharge = itemSurcharge;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ChangedItemStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemFields"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemSurcharge"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemSurchargeStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
