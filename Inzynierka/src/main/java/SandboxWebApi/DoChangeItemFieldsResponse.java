...
public class DoChangeItemFieldsResponse  implements java.io.Serializable {
    private SandboxWebApi.ChangedItemStruct changedItem;

    public DoChangeItemFieldsResponse() {
    }

    public DoChangeItemFieldsResponse(
           SandboxWebApi.ChangedItemStruct changedItem) {
     ...
     * @return changedItem
     */
    public SandboxWebApi.ChangedItemStruct getChangedItem() {
        return changedItem;
    }
     ...
     * @param changedItem
     */
    public void setChangedItem(SandboxWebApi.ChangedItemStruct changedItem) {
        this.changedItem = changedItem;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doChangeItemFieldsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("changedItem");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "changedItem"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ChangedItemStruct"));
