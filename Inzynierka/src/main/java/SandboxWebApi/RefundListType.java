...
public class RefundListType  implements java.io.Serializable {
    ...
    private SandboxWebApi.RefundDetailsType refundDetails;
    ...
    public RefundListType(
           ...
           SandboxWebApi.RefundDetailsType refundDetails) {
           this.dealId = dealId;
     ...
     */
    public SandboxWebApi.RefundDetailsType getRefundDetails() {
        return refundDetails;
    }
     ...
     * @param refundDetails
     */
    public void setRefundDetails(SandboxWebApi.RefundDetailsType refundDetails) {
        this.refundDetails = refundDetails;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RefundListType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dealId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "dealId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dealDate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "dealDate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("buyerId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "buyerId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("buyerLogin");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "buyerLogin"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "refundDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RefundDetailsType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
