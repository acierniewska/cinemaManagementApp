...
public class ProductStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.ProductParametersGroupStruct[] productParametersGroupList;
    ...
    public ProductStruct(
           ...
           SandboxWebApi.ProductParametersGroupStruct[] productParametersGroupList) {
     ...
     */
    public SandboxWebApi.ProductParametersGroupStruct[] getProductParametersGroupList() {
        return productParametersGroupList;
    }
     ...
     */
    public void setProductParametersGroupList(SandboxWebApi.ProductParametersGroupStruct[] productParametersGroupList) {
        this.productParametersGroupList = productParametersGroupList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ProductStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("productId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("productName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("productDescription");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("productImagesList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productImagesList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productParametersGroupList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ProductParametersGroupStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
