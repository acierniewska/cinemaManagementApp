...
public class TransactionPayByLinkStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.ActionDataStruct[] actionData;
    ...
    public TransactionPayByLinkStruct(
           ...
           SandboxWebApi.ActionDataStruct[] actionData) {
     ...
     * @return actionData
     */
    public SandboxWebApi.ActionDataStruct[] getActionData() {
        return actionData;
    }
     ...
     * @param actionData
     */
    public void setActionData(SandboxWebApi.ActionDataStruct[] actionData) {
        this.actionData = actionData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "TransactionPayByLinkStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actionHttpMethod");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "actionHttpMethod"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actionUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "actionUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actionData");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "actionData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ActionDataStruct"));
