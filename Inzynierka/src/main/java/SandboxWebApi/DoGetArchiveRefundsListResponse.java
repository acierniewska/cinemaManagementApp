...
public class DoGetArchiveRefundsListResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.ArchiveRefundsListTypeStruct[] refundsList;
    ...
    public DoGetArchiveRefundsListResponse(
           int refundsCount,
           SandboxWebApi.ArchiveRefundsListTypeStruct[] refundsList) {
     ...
     * @return refundsList
     */
    public SandboxWebApi.ArchiveRefundsListTypeStruct[] getRefundsList() {
        return refundsList;
    }
     ...
     * @param refundsList
     */
    public void setRefundsList(SandboxWebApi.ArchiveRefundsListTypeStruct[] refundsList) {
        this.refundsList = refundsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetArchiveRefundsListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ArchiveRefundsListTypeStruct"));
