...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements SandboxWebApi.ServiceService {
    ...
    private java.lang.String servicePort_address = "https://webapi.allegro.pl.webapisandbox.pl/service.php";
    ...
    public SandboxWebApi.ServicePort getservicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SandboxWebApi.ServiceBindingStub _stub = new SandboxWebApi.ServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SandboxWebApi.ServicePort.class.isAssignableFrom(serviceEndpointInterface)) {
                SandboxWebApi.ServiceBindingStub _stub = new SandboxWebApi.ServiceBindingStub(new java.net.URL(servicePort_address), this);
                _stub.setPortName(getservicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:SandboxWebApi", "serviceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:SandboxWebApi", "servicePort"));
        }
