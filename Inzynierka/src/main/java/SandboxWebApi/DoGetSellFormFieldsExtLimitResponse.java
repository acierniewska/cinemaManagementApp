...
public class DoGetSellFormFieldsExtLimitResponse  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetSellFormFieldsExtLimitResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "formFieldsCount"));
