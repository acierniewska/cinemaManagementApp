...
public class DoFinishItemsResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.FinishFailureStruct[] finishItemsFailed;
    ...
    public DoFinishItemsResponse(
           ...
           SandboxWebApi.FinishFailureStruct[] finishItemsFailed) {
     ...
     */
    public SandboxWebApi.FinishFailureStruct[] getFinishItemsFailed() {
        return finishItemsFailed;
    }
     ...
     */
    public void setFinishItemsFailed(SandboxWebApi.FinishFailureStruct[] finishItemsFailed) {
        this.finishItemsFailed = finishItemsFailed;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doFinishItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("finishItemsSucceed");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "finishItemsSucceed"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "finishItemsFailed"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FinishFailureStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
