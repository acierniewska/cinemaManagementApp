...
public class SellFilterOptionsStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.FilterPriceStruct filterPrice;
    ...
    public SellFilterOptionsStruct(
           ...
           SandboxWebApi.FilterPriceStruct filterPrice) {
     ...
     * @return filterPrice
     */
    public SandboxWebApi.FilterPriceStruct getFilterPrice() {
        return filterPrice;
    }
     ...
     * @param filterPrice
     */
    public void setFilterPrice(SandboxWebApi.FilterPriceStruct filterPrice) {
        this.filterPrice = filterPrice;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellFilterOptionsStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filterFormat");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterFormat"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterBids"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterToEnd"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterFromStart"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterAutoListing"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterPrice"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FilterPriceStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
