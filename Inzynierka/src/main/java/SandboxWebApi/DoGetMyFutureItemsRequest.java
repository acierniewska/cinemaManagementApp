...
public class DoGetMyFutureItemsRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.FutureFilterOptionsStruct filterOptions;
    ...
    public DoGetMyFutureItemsRequest(
           ...
           SandboxWebApi.FutureFilterOptionsStruct filterOptions,
     ...
     */
    public SandboxWebApi.FutureFilterOptionsStruct getFilterOptions() {
        return filterOptions;
    }
     ...
     * @param filterOptions
     */
    public void setFilterOptions(SandboxWebApi.FutureFilterOptionsStruct filterOptions) {
        this.filterOptions = filterOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoGetMyFutureItemsRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FutureFilterOptionsStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
