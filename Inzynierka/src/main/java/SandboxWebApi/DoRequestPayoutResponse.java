...
public class DoRequestPayoutResponse  implements java.io.Serializable {
    private SandboxWebApi.RequestPayoutStruct requestPayout;

    public DoRequestPayoutResponse() {
    }

    public DoRequestPayoutResponse(
           SandboxWebApi.RequestPayoutStruct requestPayout) {
     ...
     */
    public SandboxWebApi.RequestPayoutStruct getRequestPayout() {
        return requestPayout;
    }
     ...
     * @param requestPayout
     */
    public void setRequestPayout(SandboxWebApi.RequestPayoutStruct requestPayout) {
        this.requestPayout = requestPayout;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doRequestPayoutResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("requestPayout");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "requestPayout"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RequestPayoutStruct"));
