...
public class FilterOptionsType  implements java.io.Serializable {
    ...
    private SandboxWebApi.RangeValueType filterValueRange;
    ...
    public FilterOptionsType(
           ...
           SandboxWebApi.RangeValueType filterValueRange) {
     ...
     */
    public SandboxWebApi.RangeValueType getFilterValueRange() {
        return filterValueRange;
    }
     ...
     */
    public void setFilterValueRange(SandboxWebApi.RangeValueType filterValueRange) {
        this.filterValueRange = filterValueRange;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FilterOptionsType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterValueId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filterValueRange"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RangeValueType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
