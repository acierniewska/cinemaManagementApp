...
public class DoGetFavouriteSellersResponse  implements java.io.Serializable {
    private SandboxWebApi.FavouritesSellersStruct[] sFavouriteSellersList;

    public DoGetFavouriteSellersResponse() {
    }

    public DoGetFavouriteSellersResponse(
           SandboxWebApi.FavouritesSellersStruct[] sFavouriteSellersList) {
     ...
     */
    public SandboxWebApi.FavouritesSellersStruct[] getSFavouriteSellersList() {
        return sFavouriteSellersList;
    }
     ...
     */
    public void setSFavouriteSellersList(SandboxWebApi.FavouritesSellersStruct[] sFavouriteSellersList) {
        this.sFavouriteSellersList = sFavouriteSellersList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetFavouriteSellersResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("SFavouriteSellersList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sFavouriteSellersList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FavouritesSellersStruct"));
