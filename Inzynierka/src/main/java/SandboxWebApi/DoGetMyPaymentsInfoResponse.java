...
public class DoGetMyPaymentsInfoResponse  implements java.io.Serializable {
    private SandboxWebApi.PaymentsInfoStruct paymentsInfo;

    public DoGetMyPaymentsInfoResponse() {
    }

    public DoGetMyPaymentsInfoResponse(
           SandboxWebApi.PaymentsInfoStruct paymentsInfo) {
     ...
     * @return paymentsInfo
     */
    public SandboxWebApi.PaymentsInfoStruct getPaymentsInfo() {
        return paymentsInfo;
    }
     ...
     * @param paymentsInfo
     */
    public void setPaymentsInfo(SandboxWebApi.PaymentsInfoStruct paymentsInfo) {
        this.paymentsInfo = paymentsInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyPaymentsInfoResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentsInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentsInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentsInfoStruct"));
