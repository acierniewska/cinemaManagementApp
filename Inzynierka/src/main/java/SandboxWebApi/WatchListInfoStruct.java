...
public class WatchListInfoStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.ItemsNotAddedStruct[] itemsNotAdded;
    ...
    public WatchListInfoStruct(
           long[] itemsAdded,
           SandboxWebApi.ItemsNotAddedStruct[] itemsNotAdded) {
     ...
     */
    public SandboxWebApi.ItemsNotAddedStruct[] getItemsNotAdded() {
        return itemsNotAdded;
    }
     ...
     * @param itemsNotAdded
     */
    public void setItemsNotAdded(SandboxWebApi.ItemsNotAddedStruct[] itemsNotAdded) {
        this.itemsNotAdded = itemsNotAdded;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "WatchListInfoStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemsAdded");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemsAdded"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemsNotAdded"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemsNotAddedStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
