...
public class PayoutAutoSettingsStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.PayoutAutoFrequencyStruct payoutAutoFrequency;
    ...
    public PayoutAutoSettingsStruct(
           ...
           SandboxWebApi.PayoutAutoFrequencyStruct payoutAutoFrequency) {
     ...
     */
    public SandboxWebApi.PayoutAutoFrequencyStruct getPayoutAutoFrequency() {
        return payoutAutoFrequency;
    }
     ...
     */
    public void setPayoutAutoFrequency(SandboxWebApi.PayoutAutoFrequencyStruct payoutAutoFrequency) {
        this.payoutAutoFrequency = payoutAutoFrequency;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PayoutAutoSettingsStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payoutAutoAmount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payoutAutoAmount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "float"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payoutAutoFrequency");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payoutAutoFrequency"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PayoutAutoFrequencyStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
