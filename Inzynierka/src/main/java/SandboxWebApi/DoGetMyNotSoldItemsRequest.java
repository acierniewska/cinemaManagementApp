...
public class DoGetMyNotSoldItemsRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.NotSoldFilterOptionsStruct filterOptions;
    ...
    public DoGetMyNotSoldItemsRequest(
           ...
           SandboxWebApi.NotSoldFilterOptionsStruct filterOptions,
     ...
     */
    public SandboxWebApi.NotSoldFilterOptionsStruct getFilterOptions() {
        return filterOptions;
    }
     ...
     * @param filterOptions
     */
    public void setFilterOptions(SandboxWebApi.NotSoldFilterOptionsStruct filterOptions) {
        this.filterOptions = filterOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoGetMyNotSoldItemsRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "NotSoldFilterOptionsStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
