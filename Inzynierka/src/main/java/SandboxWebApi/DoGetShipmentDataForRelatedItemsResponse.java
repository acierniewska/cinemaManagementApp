...
public class DoGetShipmentDataForRelatedItemsResponse  implements java.io.Serializable {
    private SandboxWebApi.RelatedItemsShipmentDataStruct relatedItemsShipmentData;

    public DoGetShipmentDataForRelatedItemsResponse() {
    }

    public DoGetShipmentDataForRelatedItemsResponse(
           SandboxWebApi.RelatedItemsShipmentDataStruct relatedItemsShipmentData) {
     ...
     */
    public SandboxWebApi.RelatedItemsShipmentDataStruct getRelatedItemsShipmentData() {
        return relatedItemsShipmentData;
    }
     ...
     */
    public void setRelatedItemsShipmentData(SandboxWebApi.RelatedItemsShipmentDataStruct relatedItemsShipmentData) {
        this.relatedItemsShipmentData = relatedItemsShipmentData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetShipmentDataForRelatedItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("relatedItemsShipmentData");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "relatedItemsShipmentData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RelatedItemsShipmentDataStruct"));
