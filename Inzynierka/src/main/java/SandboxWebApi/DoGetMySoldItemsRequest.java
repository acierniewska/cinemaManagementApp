...
public class DoGetMySoldItemsRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.SoldFilterOptionsStruct filterOptions;
    ...
    public DoGetMySoldItemsRequest(
           ...
           SandboxWebApi.SoldFilterOptionsStruct filterOptions,
     ...
     */
    public SandboxWebApi.SoldFilterOptionsStruct getFilterOptions() {
        return filterOptions;
    }
     ...
     * @param filterOptions
     */
    public void setFilterOptions(SandboxWebApi.SoldFilterOptionsStruct filterOptions) {
        this.filterOptions = filterOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoGetMySoldItemsRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SoldFilterOptionsStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
