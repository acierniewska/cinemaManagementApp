...
public class DoSearchRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.SearchOptType searchQuery;
    ...
    public DoSearchRequest(
           ...
           SandboxWebApi.SearchOptType searchQuery) {
     ...
     * @return searchQuery
     */
    public SandboxWebApi.SearchOptType getSearchQuery() {
        return searchQuery;
    }
     ...
     * @param searchQuery
     */
    public void setSearchQuery(SandboxWebApi.SearchOptType searchQuery) {
        this.searchQuery = searchQuery;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoSearchRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "searchQuery"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SearchOptType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
