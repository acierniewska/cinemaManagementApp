...
public class MyFeedbackListStruct2  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "MyFeedbackListStruct2"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("feedbackArray");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "feedbackArray"));
