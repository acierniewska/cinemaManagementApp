...
public class AddressInfoStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.AddressUserDataStruct addressUserData;
    ...
    public AddressInfoStruct(
           int addressType,
           SandboxWebApi.AddressUserDataStruct addressUserData) {
     ...
     */
    public SandboxWebApi.AddressUserDataStruct getAddressUserData() {
        return addressUserData;
    }
     ...
     */
    public void setAddressUserData(SandboxWebApi.AddressUserDataStruct addressUserData) {
        this.addressUserData = addressUserData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "AddressInfoStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("addressType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "addressType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("addressUserData");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "addressUserData"));
