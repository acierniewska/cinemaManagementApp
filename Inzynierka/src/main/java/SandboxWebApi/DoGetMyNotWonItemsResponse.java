...
public class DoGetMyNotWonItemsResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.NotWonItemStruct[] notWonItemsList;
    ...
    public DoGetMyNotWonItemsResponse(
           ...
           SandboxWebApi.NotWonItemStruct[] notWonItemsList) {
     ...
     */
    public SandboxWebApi.NotWonItemStruct[] getNotWonItemsList() {
        return notWonItemsList;
    }
     ...
     */
    public void setNotWonItemsList(SandboxWebApi.NotWonItemStruct[] notWonItemsList) {
        this.notWonItemsList = notWonItemsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyNotWonItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("notWonItemsCounter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "notWonItemsCounter"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("notWonItemsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "notWonItemsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "NotWonItemStruct"));
