...
public class DoGetMyPaymentsResponse  implements java.io.Serializable {
    private SandboxWebApi.UserPaymentStruct[] payTransPayment;

    public DoGetMyPaymentsResponse() {
    }

    public DoGetMyPaymentsResponse(
           SandboxWebApi.UserPaymentStruct[] payTransPayment) {
     ...
     */
    public SandboxWebApi.UserPaymentStruct[] getPayTransPayment() {
        return payTransPayment;
    }
     ...
     */
    public void setPayTransPayment(SandboxWebApi.UserPaymentStruct[] payTransPayment) {
        this.payTransPayment = payTransPayment;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyPaymentsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransPayment");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransPayment"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserPaymentStruct"));
