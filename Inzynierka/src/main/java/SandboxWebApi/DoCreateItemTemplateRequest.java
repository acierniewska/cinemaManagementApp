...
public class DoCreateItemTemplateRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.FieldsValue[] itemTemplateFields;
    ...
    public DoCreateItemTemplateRequest(
           ...
           SandboxWebApi.FieldsValue[] itemTemplateFields) {
     ...
     */
    public SandboxWebApi.FieldsValue[] getItemTemplateFields() {
        return itemTemplateFields;
    }
     ...
     */
    public void setItemTemplateFields(SandboxWebApi.FieldsValue[] itemTemplateFields) {
        this.itemTemplateFields = itemTemplateFields;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoCreateItemTemplateRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemTemplateName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemTemplateFields");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemTemplateFields"));
