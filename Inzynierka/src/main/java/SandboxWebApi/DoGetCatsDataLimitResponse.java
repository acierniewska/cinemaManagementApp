...
public class DoGetCatsDataLimitResponse  implements java.io.Serializable {
    private SandboxWebApi.CatInfoType[] catsList;
    ...
    public DoGetCatsDataLimitResponse(
           SandboxWebApi.CatInfoType[] catsList,
           long verKey,
     ...
     * @return catsList
     */
    public SandboxWebApi.CatInfoType[] getCatsList() {
        return catsList;
    }
     ...
     * @param catsList
     */
    public void setCatsList(SandboxWebApi.CatInfoType[] catsList) {
        this.catsList = catsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetCatsDataLimitResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("catsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catsList"));
