...
public class DoRemoveFromBlackListResponse  implements java.io.Serializable {
    private SandboxWebApi.BlackListResStruct[] blackListResult;

    public DoRemoveFromBlackListResponse() {
    }

    public DoRemoveFromBlackListResponse(
           SandboxWebApi.BlackListResStruct[] blackListResult) {
     ...
     */
    public SandboxWebApi.BlackListResStruct[] getBlackListResult() {
        return blackListResult;
    }
     ...
     */
    public void setBlackListResult(SandboxWebApi.BlackListResStruct[] blackListResult) {
        this.blackListResult = blackListResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doRemoveFromBlackListResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("blackListResult");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "blackListResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "BlackListResStruct"));
