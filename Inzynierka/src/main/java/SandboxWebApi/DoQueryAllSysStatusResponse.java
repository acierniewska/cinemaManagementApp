...
public class DoQueryAllSysStatusResponse  implements java.io.Serializable {
    private SandboxWebApi.SysStatusType[] sysCountryStatus;

    public DoQueryAllSysStatusResponse() {
    }

    public DoQueryAllSysStatusResponse(
           SandboxWebApi.SysStatusType[] sysCountryStatus) {
     ...
     */
    public SandboxWebApi.SysStatusType[] getSysCountryStatus() {
        return sysCountryStatus;
    }
     ...
     */
    public void setSysCountryStatus(SandboxWebApi.SysStatusType[] sysCountryStatus) {
        this.sysCountryStatus = sysCountryStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doQueryAllSysStatusResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sysCountryStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sysCountryStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SysStatusType"));
