...
public class PaymentsPayoutStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.PayoutAutoSettingsStruct payoutAutoSettings;
    ...
    public PaymentsPayoutStruct(
           int payoutType,
           SandboxWebApi.PayoutAutoSettingsStruct payoutAutoSettings) {
     ...
     */
    public SandboxWebApi.PayoutAutoSettingsStruct getPayoutAutoSettings() {
        return payoutAutoSettings;
    }
     ...
     */
    public void setPayoutAutoSettings(SandboxWebApi.PayoutAutoSettingsStruct payoutAutoSettings) {
        this.payoutAutoSettings = payoutAutoSettings;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentsPayoutStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payoutType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payoutType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payoutAutoSettings");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payoutAutoSettings"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PayoutAutoSettingsStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
