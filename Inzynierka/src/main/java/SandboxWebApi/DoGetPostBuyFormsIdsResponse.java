...
public class DoGetPostBuyFormsIdsResponse  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetPostBuyFormsIdsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("formsCount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "formsCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("formsIds");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "formsIds"));
