...
public class DoGetMyIncomingPaymentsRefundsResponse  implements java.io.Serializable {
    private SandboxWebApi.UserIncomingPaymentRefundsStruct[] payTransIncomeRefunds;

    public DoGetMyIncomingPaymentsRefundsResponse() {
    }

    public DoGetMyIncomingPaymentsRefundsResponse(
           SandboxWebApi.UserIncomingPaymentRefundsStruct[] payTransIncomeRefunds) {
     ...
     */
    public SandboxWebApi.UserIncomingPaymentRefundsStruct[] getPayTransIncomeRefunds() {
        return payTransIncomeRefunds;
    }
     ...
     */
    public void setPayTransIncomeRefunds(SandboxWebApi.UserIncomingPaymentRefundsStruct[] payTransIncomeRefunds) {
        this.payTransIncomeRefunds = payTransIncomeRefunds;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyIncomingPaymentsRefundsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransIncomeRefunds");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransIncomeRefunds"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserIncomingPaymentRefundsStruct"));
