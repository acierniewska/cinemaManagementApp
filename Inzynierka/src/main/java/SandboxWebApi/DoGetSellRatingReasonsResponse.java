...
public class DoGetSellRatingReasonsResponse  implements java.io.Serializable {
    private SandboxWebApi.SellRatingInfoStruct[] sellRatingInfo;

    public DoGetSellRatingReasonsResponse() {
    }

    public DoGetSellRatingReasonsResponse(
           SandboxWebApi.SellRatingInfoStruct[] sellRatingInfo) {
     ...
     */
    public SandboxWebApi.SellRatingInfoStruct[] getSellRatingInfo() {
        return sellRatingInfo;
    }
     ...
     */
    public void setSellRatingInfo(SandboxWebApi.SellRatingInfoStruct[] sellRatingInfo) {
        this.sellRatingInfo = sellRatingInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetSellRatingReasonsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingInfoStruct"));
