...
public class CategoriesListType  implements java.io.Serializable {
    private SandboxWebApi.CategoryTreeType[] categoriesTree;

    private SandboxWebApi.CategoryPathType[] categoriesPath;

    public CategoriesListType() {
    }

    public CategoriesListType(
           SandboxWebApi.CategoryTreeType[] categoriesTree,
           SandboxWebApi.CategoryPathType[] categoriesPath) {
     ...
     */
    public SandboxWebApi.CategoryTreeType[] getCategoriesTree() {
        return categoriesTree;
    }
     ...
     */
    public void setCategoriesTree(SandboxWebApi.CategoryTreeType[] categoriesTree) {
        this.categoriesTree = categoriesTree;
    }
     ...
     */
    public SandboxWebApi.CategoryPathType[] getCategoriesPath() {
        return categoriesPath;
    }
     ...
     */
    public void setCategoriesPath(SandboxWebApi.CategoryPathType[] categoriesPath) {
        this.categoriesPath = categoriesPath;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "CategoriesListType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("categoriesTree");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "categoriesTree"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "CategoryTreeType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "categoriesPath"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "CategoryPathType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
