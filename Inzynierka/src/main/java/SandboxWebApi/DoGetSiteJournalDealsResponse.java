...
public class DoGetSiteJournalDealsResponse  implements java.io.Serializable {
    private SandboxWebApi.SiteJournalDealsStruct[] siteJournalDeals;

    public DoGetSiteJournalDealsResponse() {
    }

    public DoGetSiteJournalDealsResponse(
           SandboxWebApi.SiteJournalDealsStruct[] siteJournalDeals) {
     ...
     */
    public SandboxWebApi.SiteJournalDealsStruct[] getSiteJournalDeals() {
        return siteJournalDeals;
    }
     ...
     */
    public void setSiteJournalDeals(SandboxWebApi.SiteJournalDealsStruct[] siteJournalDeals) {
        this.siteJournalDeals = siteJournalDeals;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetSiteJournalDealsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("siteJournalDeals");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "siteJournalDeals"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SiteJournalDealsStruct"));
