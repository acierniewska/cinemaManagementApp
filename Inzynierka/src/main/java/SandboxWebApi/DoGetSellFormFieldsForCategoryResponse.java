...
public class DoGetSellFormFieldsForCategoryResponse  implements java.io.Serializable {
    private SandboxWebApi.SellFormFieldsForCategoryStruct sellFormFieldsForCategory;

    public DoGetSellFormFieldsForCategoryResponse() {
    }

    public DoGetSellFormFieldsForCategoryResponse(
           SandboxWebApi.SellFormFieldsForCategoryStruct sellFormFieldsForCategory) {
     ...
     */
    public SandboxWebApi.SellFormFieldsForCategoryStruct getSellFormFieldsForCategory() {
        return sellFormFieldsForCategory;
    }
     ...
     */
    public void setSellFormFieldsForCategory(SandboxWebApi.SellFormFieldsForCategoryStruct sellFormFieldsForCategory) {
        this.sellFormFieldsForCategory = sellFormFieldsForCategory;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetSellFormFieldsForCategoryResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellFormFieldsForCategory");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellFormFieldsForCategory"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellFormFieldsForCategoryStruct"));
