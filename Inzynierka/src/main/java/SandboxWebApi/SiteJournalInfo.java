...
public class SiteJournalInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SiteJournalInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemsNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemsNumber"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("lastItemDate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "lastItemDate"));
