...
public class NewPostBuyFormCommonStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.AddressUserDataStruct shipmentAddressData;

    private java.lang.String contactPhone;

    private int invoiceOption;

    private SandboxWebApi.InvoiceInfoStruct invoiceInfo;
    ...
    public NewPostBuyFormCommonStruct(
           ...
           SandboxWebApi.AddressUserDataStruct shipmentAddressData,
           java.lang.String contactPhone,
           int invoiceOption,
           SandboxWebApi.InvoiceInfoStruct invoiceInfo) {
     ...
     */
    public SandboxWebApi.AddressUserDataStruct getShipmentAddressData() {
        return shipmentAddressData;
    }
     ...
     */
    public void setShipmentAddressData(SandboxWebApi.AddressUserDataStruct shipmentAddressData) {
        this.shipmentAddressData = shipmentAddressData;
    }
     ...
     * @return invoiceInfo
     */
    public SandboxWebApi.InvoiceInfoStruct getInvoiceInfo() {
        return invoiceInfo;
    }
     ...
     * @param invoiceInfo
     */
    public void setInvoiceInfo(SandboxWebApi.InvoiceInfoStruct invoiceInfo) {
        this.invoiceInfo = invoiceInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "NewPostBuyFormCommonStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentMethodId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentMethodId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentAddressType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentAddressType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentAddressData");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentAddressData"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "invoiceOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("invoiceInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "invoiceInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "InvoiceInfoStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
