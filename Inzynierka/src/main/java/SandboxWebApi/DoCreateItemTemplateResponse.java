...
public class DoCreateItemTemplateResponse  implements java.io.Serializable {
    private SandboxWebApi.CreatedItemTemplateStruct createdItemTemplate;

    public DoCreateItemTemplateResponse() {
    }

    public DoCreateItemTemplateResponse(
           SandboxWebApi.CreatedItemTemplateStruct createdItemTemplate) {
     ...
     */
    public SandboxWebApi.CreatedItemTemplateStruct getCreatedItemTemplate() {
        return createdItemTemplate;
    }
     ...
     */
    public void setCreatedItemTemplate(SandboxWebApi.CreatedItemTemplateStruct createdItemTemplate) {
        this.createdItemTemplate = createdItemTemplate;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doCreateItemTemplateResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("createdItemTemplate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "createdItemTemplate"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "CreatedItemTemplateStruct"));
