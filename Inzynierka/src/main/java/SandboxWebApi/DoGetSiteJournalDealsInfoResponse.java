...
public class DoGetSiteJournalDealsInfoResponse  implements java.io.Serializable {
    private SandboxWebApi.SiteJournalDealsInfoStruct siteJournalDealsInfo;

    public DoGetSiteJournalDealsInfoResponse() {
    }

    public DoGetSiteJournalDealsInfoResponse(
           SandboxWebApi.SiteJournalDealsInfoStruct siteJournalDealsInfo) {
     ...
     */
    public SandboxWebApi.SiteJournalDealsInfoStruct getSiteJournalDealsInfo() {
        return siteJournalDealsInfo;
    }
     ...
     */
    public void setSiteJournalDealsInfo(SandboxWebApi.SiteJournalDealsInfoStruct siteJournalDealsInfo) {
        this.siteJournalDealsInfo = siteJournalDealsInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetSiteJournalDealsInfoResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("siteJournalDealsInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "siteJournalDealsInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SiteJournalDealsInfoStruct"));
