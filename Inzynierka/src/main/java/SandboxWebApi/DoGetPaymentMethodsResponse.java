...
public class DoGetPaymentMethodsResponse  implements java.io.Serializable {
    private SandboxWebApi.PaymentMethodStruct[] paymentMethods;

    public DoGetPaymentMethodsResponse() {
    }

    public DoGetPaymentMethodsResponse(
           SandboxWebApi.PaymentMethodStruct[] paymentMethods) {
     ...
     */
    public SandboxWebApi.PaymentMethodStruct[] getPaymentMethods() {
        return paymentMethods;
    }
     ...
     */
    public void setPaymentMethods(SandboxWebApi.PaymentMethodStruct[] paymentMethods) {
        this.paymentMethods = paymentMethods;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetPaymentMethodsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("paymentMethods");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "paymentMethods"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentMethodStruct"));
