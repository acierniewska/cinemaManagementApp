...
public class DoGetSiteJournalResponse  implements java.io.Serializable {
    private SandboxWebApi.SiteJournal[] siteJournalArray;

    public DoGetSiteJournalResponse() {
    }

    public DoGetSiteJournalResponse(
           SandboxWebApi.SiteJournal[] siteJournalArray) {
     ...
     */
    public SandboxWebApi.SiteJournal[] getSiteJournalArray() {
        return siteJournalArray;
    }
     ...
     */
    public void setSiteJournalArray(SandboxWebApi.SiteJournal[] siteJournalArray) {
        this.siteJournalArray = siteJournalArray;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetSiteJournalResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("siteJournalArray");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "siteJournalArray"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SiteJournal"));
