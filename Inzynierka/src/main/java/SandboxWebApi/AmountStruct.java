...
public class AmountStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "AmountStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("amountValue");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "amountValue"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "float"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("amountCurrencySign");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "amountCurrencySign"));
