...
public class DoGetRelatedItemsResponse  implements java.io.Serializable {
    private SandboxWebApi.RelatedItemsStruct relatedItems;

    public DoGetRelatedItemsResponse() {
    }

    public DoGetRelatedItemsResponse(
           SandboxWebApi.RelatedItemsStruct relatedItems) {
     ...
     * @return relatedItems
     */
    public SandboxWebApi.RelatedItemsStruct getRelatedItems() {
        return relatedItems;
    }
     ...
     * @param relatedItems
     */
    public void setRelatedItems(SandboxWebApi.RelatedItemsStruct relatedItems) {
        this.relatedItems = relatedItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetRelatedItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("relatedItems");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "relatedItems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RelatedItemsStruct"));
