...
public class DoGetItemTemplatesResponse  implements java.io.Serializable {
    private SandboxWebApi.ItemTemplatesStruct itemTemplates;

    public DoGetItemTemplatesResponse() {
    }

    public DoGetItemTemplatesResponse(
           SandboxWebApi.ItemTemplatesStruct itemTemplates) {
     ...
     */
    public SandboxWebApi.ItemTemplatesStruct getItemTemplates() {
        return itemTemplates;
    }
     ...
     * @param itemTemplates
     */
    public void setItemTemplates(SandboxWebApi.ItemTemplatesStruct itemTemplates) {
        this.itemTemplates = itemTemplates;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetItemTemplatesResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemTemplates");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemTemplates"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemTemplatesStruct"));
