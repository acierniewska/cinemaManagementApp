...
public class DoGetItemsListRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.SortOptionsType sortOptions;
    ...
    public DoGetItemsListRequest(
           ...
           SandboxWebApi.SortOptionsType sortOptions,
     ...
     * @return sortOptions
     */
    public SandboxWebApi.SortOptionsType getSortOptions() {
        return sortOptions;
    }
     ...
     * @param sortOptions
     */
    public void setSortOptions(SandboxWebApi.SortOptionsType sortOptions) {
        this.sortOptions = sortOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoGetItemsListRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SortOptionsType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "resultScope"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
