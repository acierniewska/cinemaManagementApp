...
public class DoGetUserItemsResponse  implements java.io.Serializable {
    private SandboxWebApi.UserItemList[] userItemList;
    ...
    public DoGetUserItemsResponse(
           SandboxWebApi.UserItemList[] userItemList,
           int userItemCount) {
     ...
     * @return userItemList
     */
    public SandboxWebApi.UserItemList[] getUserItemList() {
        return userItemList;
    }
     ...
     * @param userItemList
     */
    public void setUserItemList(SandboxWebApi.UserItemList[] userItemList) {
        this.userItemList = userItemList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetUserItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userItemList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "userItemList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserItemList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "userItemCount"));
