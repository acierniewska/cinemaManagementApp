...
public class DoGetCategoryPathResponse  implements java.io.Serializable {
    private SandboxWebApi.CategoryData[] categoryPath;

    public DoGetCategoryPathResponse() {
    }

    public DoGetCategoryPathResponse(
           SandboxWebApi.CategoryData[] categoryPath) {
     ...
     * @return categoryPath
     */
    public SandboxWebApi.CategoryData[] getCategoryPath() {
        return categoryPath;
    }
     ...
     * @param categoryPath
     */
    public void setCategoryPath(SandboxWebApi.CategoryData[] categoryPath) {
        this.categoryPath = categoryPath;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetCategoryPathResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("categoryPath");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "categoryPath"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "CategoryData"));
