...
public class DoGetMyPayoutsResponse  implements java.io.Serializable {
    private SandboxWebApi.UserPayoutStruct[] payTransPayout;

    public DoGetMyPayoutsResponse() {
    }

    public DoGetMyPayoutsResponse(
           SandboxWebApi.UserPayoutStruct[] payTransPayout) {
     ...
     */
    public SandboxWebApi.UserPayoutStruct[] getPayTransPayout() {
        return payTransPayout;
    }
     ...
     */
    public void setPayTransPayout(SandboxWebApi.UserPayoutStruct[] payTransPayout) {
        this.payTransPayout = payTransPayout;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyPayoutsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransPayout");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransPayout"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserPayoutStruct"));
