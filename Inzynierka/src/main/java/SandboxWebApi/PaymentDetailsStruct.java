...
public class PaymentDetailsStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentDetailsStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransDetailsItId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransDetailsItId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransDetailsPrice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransDetailsPrice"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "float"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransDetailsCount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransDetailsCount"));
