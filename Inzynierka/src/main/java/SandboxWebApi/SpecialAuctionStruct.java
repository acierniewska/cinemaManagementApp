...
public class SpecialAuctionStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.AttribStruct[] itAttribsList;
    ...
    public SpecialAuctionStruct(
           ...
           SandboxWebApi.AttribStruct[] itAttribsList) {
           this.itId = itId;
           this.itName = itName;
     ...
     */
    public SandboxWebApi.AttribStruct[] getItAttribsList() {
        return itAttribsList;
    }
     ...
     * @param itAttribsList
     */
    public void setItAttribsList(SandboxWebApi.AttribStruct[] itAttribsList) {
        this.itAttribsList = itAttribsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SpecialAuctionStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itSendCostPrice"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "float"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itAttribsList"));
