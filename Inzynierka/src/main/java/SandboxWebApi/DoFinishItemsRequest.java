...
public class DoFinishItemsRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.FinishItemsStruct[] finishItemsList;
    ...
    public DoFinishItemsRequest(
           ...
           SandboxWebApi.FinishItemsStruct[] finishItemsList) {
     ...
     */
    public SandboxWebApi.FinishItemsStruct[] getFinishItemsList() {
        return finishItemsList;
    }
     ...
     */
    public void setFinishItemsList(SandboxWebApi.FinishItemsStruct[] finishItemsList) {
        this.finishItemsList = finishItemsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoFinishItemsRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "finishItemsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FinishItemsStruct"));
