...
public class PostBuyFormStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.TransactionPayByLinkStruct transactionPayByLink;
    ...
    public PostBuyFormStruct(
           ...
           SandboxWebApi.TransactionPayByLinkStruct transactionPayByLink) {
     ...
     */
    public SandboxWebApi.TransactionPayByLinkStruct getTransactionPayByLink() {
        return transactionPayByLink;
    }
     ...
     */
    public void setTransactionPayByLink(SandboxWebApi.TransactionPayByLinkStruct transactionPayByLink) {
        this.transactionPayByLink = transactionPayByLink;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PostBuyFormStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "transactionPackageIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "transactionPayByLink"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "TransactionPayByLinkStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
