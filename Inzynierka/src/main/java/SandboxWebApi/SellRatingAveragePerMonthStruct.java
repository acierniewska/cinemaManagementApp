...
public class SellRatingAveragePerMonthStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellRatingStatsStruct[] sellRatingAverageValues;
    ...
    public SellRatingAveragePerMonthStruct(
           ...
           SandboxWebApi.SellRatingStatsStruct[] sellRatingAverageValues) {
     ...
     */
    public SandboxWebApi.SellRatingStatsStruct[] getSellRatingAverageValues() {
        return sellRatingAverageValues;
    }
     ...
     */
    public void setSellRatingAverageValues(SandboxWebApi.SellRatingStatsStruct[] sellRatingAverageValues) {
        this.sellRatingAverageValues = sellRatingAverageValues;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingAveragePerMonthStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingMonth");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingMonth"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellRatingAverageValues");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellRatingAverageValues"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellRatingStatsStruct"));
