...
public class DoGetMyPaymentsRefundsResponse  implements java.io.Serializable {
    private SandboxWebApi.UserPaymentRefundsStruct[] payTransPaymentRefunds;

    public DoGetMyPaymentsRefundsResponse() {
    }

    public DoGetMyPaymentsRefundsResponse(
           SandboxWebApi.UserPaymentRefundsStruct[] payTransPaymentRefunds) {
     ...
     */
    public SandboxWebApi.UserPaymentRefundsStruct[] getPayTransPaymentRefunds() {
        return payTransPaymentRefunds;
    }
     ...
     */
    public void setPayTransPaymentRefunds(SandboxWebApi.UserPaymentRefundsStruct[] payTransPaymentRefunds) {
        this.payTransPaymentRefunds = payTransPaymentRefunds;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyPaymentsRefundsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransPaymentRefunds");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransPaymentRefunds"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserPaymentRefundsStruct"));
