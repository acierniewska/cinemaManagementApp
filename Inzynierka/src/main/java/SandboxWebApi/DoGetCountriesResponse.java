...
public class DoGetCountriesResponse  implements java.io.Serializable {
    private SandboxWebApi.CountryInfoType[] countryArray;

    public DoGetCountriesResponse() {
    }

    public DoGetCountriesResponse(
           SandboxWebApi.CountryInfoType[] countryArray) {
     ...
     * @return countryArray
     */
    public SandboxWebApi.CountryInfoType[] getCountryArray() {
        return countryArray;
    }
     ...
     * @param countryArray
     */
    public void setCountryArray(SandboxWebApi.CountryInfoType[] countryArray) {
        this.countryArray = countryArray;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetCountriesResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("countryArray");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "countryArray"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "CountryInfoType"));
