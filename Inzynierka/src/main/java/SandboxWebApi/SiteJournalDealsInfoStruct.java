...
public class SiteJournalDealsInfoStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SiteJournalDealsInfoStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dealEventsCount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "dealEventsCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dealLastEventTime");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "dealLastEventTime"));
