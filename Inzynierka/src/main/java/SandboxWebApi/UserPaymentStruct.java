...
public class UserPaymentStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.PaymentSellersStruct[] payTransSellers;
    ...
    public UserPaymentStruct(
           long payTransId,
           SandboxWebApi.PaymentSellersStruct[] payTransSellers,
     ...
     */
    public SandboxWebApi.PaymentSellersStruct[] getPayTransSellers() {
        return payTransSellers;
    }
     ...
     */
    public void setPayTransSellers(SandboxWebApi.PaymentSellersStruct[] payTransSellers) {
        this.payTransSellers = payTransSellers;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserPaymentStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransSellers"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentSellersStruct"));
