...
public class DoSendPostBuyFormRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.NewPostBuyFormSellerStruct[] newPostBuyFormSeller;

    private SandboxWebApi.NewPostBuyFormCommonStruct newPostBuyFormCommon;
    ...
    public DoSendPostBuyFormRequest(
           ...
           SandboxWebApi.NewPostBuyFormSellerStruct[] newPostBuyFormSeller,
           SandboxWebApi.NewPostBuyFormCommonStruct newPostBuyFormCommon) {
     ...
     */
    public SandboxWebApi.NewPostBuyFormSellerStruct[] getNewPostBuyFormSeller() {
        return newPostBuyFormSeller;
    }
     ...
     */
    public void setNewPostBuyFormSeller(SandboxWebApi.NewPostBuyFormSellerStruct[] newPostBuyFormSeller) {
        this.newPostBuyFormSeller = newPostBuyFormSeller;
    }
     ...
     */
    public SandboxWebApi.NewPostBuyFormCommonStruct getNewPostBuyFormCommon() {
        return newPostBuyFormCommon;
    }
     ...
     */
    public void setNewPostBuyFormCommon(SandboxWebApi.NewPostBuyFormCommonStruct newPostBuyFormCommon) {
        this.newPostBuyFormCommon = newPostBuyFormCommon;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoSendPostBuyFormRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "newPostBuyFormSeller"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "NewPostBuyFormSellerStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "newPostBuyFormCommon"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "NewPostBuyFormCommonStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
