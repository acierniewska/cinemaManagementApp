...
public class DoGetMySellItemsResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellItemStruct[] sellItemsList;
    ...
    public DoGetMySellItemsResponse(
           ...
           SandboxWebApi.SellItemStruct[] sellItemsList) {
     ...
     */
    public SandboxWebApi.SellItemStruct[] getSellItemsList() {
        return sellItemsList;
    }
     ...
     * @param sellItemsList
     */
    public void setSellItemsList(SandboxWebApi.SellItemStruct[] sellItemsList) {
        this.sellItemsList = sellItemsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMySellItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellItemsCounter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellItemsCounter"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellItemsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellItemsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellItemStruct"));
