...
public class DoGetMyIncomingPaymentsResponse  implements java.io.Serializable {
    private SandboxWebApi.UserIncomingPaymentStruct[] payTransIncome;

    public DoGetMyIncomingPaymentsResponse() {
    }

    public DoGetMyIncomingPaymentsResponse(
           SandboxWebApi.UserIncomingPaymentStruct[] payTransIncome) {
     ...
     */
    public SandboxWebApi.UserIncomingPaymentStruct[] getPayTransIncome() {
        return payTransIncome;
    }
     ...
     */
    public void setPayTransIncome(SandboxWebApi.UserIncomingPaymentStruct[] payTransIncome) {
        this.payTransIncome = payTransIncome;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyIncomingPaymentsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransIncome");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransIncome"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserIncomingPaymentStruct"));
