...
public class ItemPostBuyDataStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.UserPostBuyDataStruct[] usersPostBuyData;
    ...
    public ItemPostBuyDataStruct(
           long itemId,
           SandboxWebApi.UserPostBuyDataStruct[] usersPostBuyData) {
           this.itemId = itemId;
     ...
     */
    public SandboxWebApi.UserPostBuyDataStruct[] getUsersPostBuyData() {
        return usersPostBuyData;
    }
     ...
     */
    public void setUsersPostBuyData(SandboxWebApi.UserPostBuyDataStruct[] usersPostBuyData) {
        this.usersPostBuyData = usersPostBuyData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemPostBuyDataStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "usersPostBuyData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "UserPostBuyDataStruct"));
