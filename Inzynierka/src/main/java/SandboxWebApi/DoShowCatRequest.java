...
public class DoShowCatRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.DurationTimeInfo catItemDurationOption;

    private SandboxWebApi.FieldsValue[] catAttribFields;

    private java.lang.Integer catSortOptions;

    private SandboxWebApi.PriceCatInfo catItemsPrice;
    ...
    public DoShowCatRequest(
           ...
           SandboxWebApi.DurationTimeInfo catItemDurationOption,
           SandboxWebApi.FieldsValue[] catAttribFields,
           java.lang.Integer catSortOptions,
           SandboxWebApi.PriceCatInfo catItemsPrice,
     ...
     */
    public SandboxWebApi.DurationTimeInfo getCatItemDurationOption() {
        return catItemDurationOption;
    }
     ...
     */
    public void setCatItemDurationOption(SandboxWebApi.DurationTimeInfo catItemDurationOption) {
        this.catItemDurationOption = catItemDurationOption;
    }
     ...
     */
    public SandboxWebApi.FieldsValue[] getCatAttribFields() {
        return catAttribFields;
    }
     ...
     */
    public void setCatAttribFields(SandboxWebApi.FieldsValue[] catAttribFields) {
        this.catAttribFields = catAttribFields;
    }
     ...
     */
    public SandboxWebApi.PriceCatInfo getCatItemsPrice() {
        return catItemsPrice;
    }
     ...
     * @param catItemsPrice
     */
    public void setCatItemsPrice(SandboxWebApi.PriceCatInfo catItemsPrice) {
        this.catItemsPrice = catItemsPrice;
    }
        ...
        _equals = true && 
            ...
            ((this.catAttribFields==null && other.getCatAttribFields()==null) || 
             (this.catAttribFields!=null &&
              java.util.Arrays.equals(this.catAttribFields, other.getCatAttribFields()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCatAttribFields() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCatAttribFields());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCatAttribFields(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoShowCatRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catItemState"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catItemOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catItemDurationOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "DurationTimeInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("catAttribFields");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catAttribFields"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catSortOptions"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catItemsPrice"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PriceCatInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("catItemsOffset");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catItemsOffset"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catItemsLimit"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "catOrderFulfillmentTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
