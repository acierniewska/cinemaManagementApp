...
public class SellerShipmentDataStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellerPaymentInfoStruct sellerPaymentInfo;

    private int sellerOtherShipmentIsActive;

    private SandboxWebApi.ShipmentPaymentInfoStruct[] generalDeliveryPaymentInfo;
    ...
    public SellerShipmentDataStruct(
           int sellerId,
           SandboxWebApi.SellerPaymentInfoStruct sellerPaymentInfo,
           int sellerOtherShipmentIsActive,
           SandboxWebApi.ShipmentPaymentInfoStruct[] generalDeliveryPaymentInfo) {
     ...
     */
    public SandboxWebApi.SellerPaymentInfoStruct getSellerPaymentInfo() {
        return sellerPaymentInfo;
    }
     ...
     */
    public void setSellerPaymentInfo(SandboxWebApi.SellerPaymentInfoStruct sellerPaymentInfo) {
        this.sellerPaymentInfo = sellerPaymentInfo;
    }
     ...
     */
    public SandboxWebApi.ShipmentPaymentInfoStruct[] getGeneralDeliveryPaymentInfo() {
        return generalDeliveryPaymentInfo;
    }
     ...
     */
    public void setGeneralDeliveryPaymentInfo(SandboxWebApi.ShipmentPaymentInfoStruct[] generalDeliveryPaymentInfo) {
        this.generalDeliveryPaymentInfo = generalDeliveryPaymentInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellerShipmentDataStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellerId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellerId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellerPaymentInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellerPaymentInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellerPaymentInfoStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sellerOtherShipmentIsActive");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "sellerOtherShipmentIsActive"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("generalDeliveryPaymentInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "generalDeliveryPaymentInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ShipmentPaymentInfoStruct"));
