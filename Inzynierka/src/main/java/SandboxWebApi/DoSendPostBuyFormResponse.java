...
public class DoSendPostBuyFormResponse  implements java.io.Serializable {
    private SandboxWebApi.PostBuyFormStruct postBuyForm;

    public DoSendPostBuyFormResponse() {
    }

    public DoSendPostBuyFormResponse(
           SandboxWebApi.PostBuyFormStruct postBuyForm) {
     ...
     * @return postBuyForm
     */
    public SandboxWebApi.PostBuyFormStruct getPostBuyForm() {
        return postBuyForm;
    }
     ...
     * @param postBuyForm
     */
    public void setPostBuyForm(SandboxWebApi.PostBuyFormStruct postBuyForm) {
        this.postBuyForm = postBuyForm;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doSendPostBuyFormResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("postBuyForm");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "postBuyForm"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PostBuyFormStruct"));
