...
public class RangeDateValueStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "RangeDateValueStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fvalueRangeDateMin");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "fvalueRangeDateMin"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "fvalueRangeDateMax"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
