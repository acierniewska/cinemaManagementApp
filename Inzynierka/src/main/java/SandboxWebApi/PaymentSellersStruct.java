...
public class PaymentSellersStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.PaymentItemsStruct[] payTransItems;
    ...
    public PaymentSellersStruct(
           ...
           SandboxWebApi.PaymentItemsStruct[] payTransItems,
     ...
     */
    public SandboxWebApi.PaymentItemsStruct[] getPayTransItems() {
        return payTransItems;
    }
     ...
     * @param payTransItems
     */
    public void setPayTransItems(SandboxWebApi.PaymentItemsStruct[] payTransItems) {
        this.payTransItems = payTransItems;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentSellersStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransSellerId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransSellerId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransSellerName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransSellerName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payTransItems");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransItems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PaymentItemsStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "payTransSellerPostageAmount"));
