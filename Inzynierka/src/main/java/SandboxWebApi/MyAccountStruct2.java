...
public class MyAccountStruct2  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "MyAccountStruct2"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("myAccountArray");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "myAccountArray"));
