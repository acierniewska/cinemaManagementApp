...
public class ShipmentPriceTypeStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ShipmentPriceTypeStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentPriceTypeId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentPriceTypeId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentPriceTypeName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentPriceTypeName"));
