...
public class DoGetMySoldItemsResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.SoldItemStruct[] soldItemsList;
    ...
    public DoGetMySoldItemsResponse(
           ...
           SandboxWebApi.SoldItemStruct[] soldItemsList) {
     ...
     */
    public SandboxWebApi.SoldItemStruct[] getSoldItemsList() {
        return soldItemsList;
    }
     ...
     * @param soldItemsList
     */
    public void setSoldItemsList(SandboxWebApi.SoldItemStruct[] soldItemsList) {
        this.soldItemsList = soldItemsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMySoldItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("soldItemsCounter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "soldItemsCounter"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("soldItemsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "soldItemsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SoldItemStruct"));
