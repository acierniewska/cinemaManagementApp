...
public class ItemDescriptionStruct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemDescriptionStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("descriptionResult");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "descriptionResult"));
