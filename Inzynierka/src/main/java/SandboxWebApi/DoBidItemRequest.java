...
public class DoBidItemRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.PharmacyRecipientDataStruct pharmacyRecipientData;
    ...
    public DoBidItemRequest(
           ...
           SandboxWebApi.PharmacyRecipientDataStruct pharmacyRecipientData,
     ...
     */
    public SandboxWebApi.PharmacyRecipientDataStruct getPharmacyRecipientData() {
        return pharmacyRecipientData;
    }
     ...
     */
    public void setPharmacyRecipientData(SandboxWebApi.PharmacyRecipientDataStruct pharmacyRecipientData) {
        this.pharmacyRecipientData = pharmacyRecipientData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoBidItemRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "bidItId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bidUserPrice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "bidUserPrice"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "float"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bidQuantity");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "bidQuantity"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bidBuyNow");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "bidBuyNow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "pharmacyRecipientData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PharmacyRecipientDataStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("variantId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "variantId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
