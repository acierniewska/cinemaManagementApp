...
public class SellerPaymentInfoStruct  implements java.io.Serializable {
    private SandboxWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza;

    private SandboxWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza;

    public SellerPaymentInfoStruct() {
    }

    public SellerPaymentInfoStruct(
           SandboxWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza,
           SandboxWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza) {
     ...
     */
    public SandboxWebApi.ShipmentPaymentInfoStruct[] getShipmentPaymentInfoPza() {
        return shipmentPaymentInfoPza;
    }
     ...
     */
    public void setShipmentPaymentInfoPza(SandboxWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza) {
        this.shipmentPaymentInfoPza = shipmentPaymentInfoPza;
    }
     ...
     */
    public SandboxWebApi.ShipmentPaymentInfoStruct[] getShipmentPaymentInfoNonPza() {
        return shipmentPaymentInfoNonPza;
    }
     ...
     */
    public void setShipmentPaymentInfoNonPza(SandboxWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza) {
        this.shipmentPaymentInfoNonPza = shipmentPaymentInfoNonPza;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellerPaymentInfoStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("shipmentPaymentInfoPza");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentPaymentInfoPza"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "shipmentPaymentInfoNonPza"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ShipmentPaymentInfoStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
