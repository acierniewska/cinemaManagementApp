...
public class ProductParametersGroupStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.ProductParametersStruct[] productParametersList;
    ...
    public ProductParametersGroupStruct(
           ...
           SandboxWebApi.ProductParametersStruct[] productParametersList) {
     ...
     */
    public SandboxWebApi.ProductParametersStruct[] getProductParametersList() {
        return productParametersList;
    }
     ...
     */
    public void setProductParametersList(SandboxWebApi.ProductParametersStruct[] productParametersList) {
        this.productParametersList = productParametersList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ProductParametersGroupStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("productParametersGroupName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productParametersGroupName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("productParametersList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "productParametersList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ProductParametersStruct"));
