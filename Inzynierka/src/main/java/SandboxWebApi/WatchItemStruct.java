...
public class WatchItemStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.ItemReminderStruct[] itemReminder;
    ...
    public WatchItemStruct(
           ...
           int itemPayuInfo,
           SandboxWebApi.ItemReminderStruct[] itemReminder) {
           this.itemId = itemId;
     ...
     * @return itemReminder
     */
    public SandboxWebApi.ItemReminderStruct[] getItemReminder() {
        return itemReminder;
    }
     ...
     * @param itemReminder
     */
    public void setItemReminder(SandboxWebApi.ItemReminderStruct[] itemReminder) {
        this.itemReminder = itemReminder;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "WatchItemStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "itemReminder"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "ItemReminderStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:SandboxWebApi", "item"));
        typeDesc.addFieldDesc(elemField);
