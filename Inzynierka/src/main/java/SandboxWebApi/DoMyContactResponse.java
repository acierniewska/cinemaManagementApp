...
public class DoMyContactResponse  implements java.io.Serializable {
    private SandboxWebApi.MyContactList[] mycontactList;

    public DoMyContactResponse() {
    }

    public DoMyContactResponse(
           SandboxWebApi.MyContactList[] mycontactList) {
     ...
     */
    public SandboxWebApi.MyContactList[] getMycontactList() {
        return mycontactList;
    }
     ...
     * @param mycontactList
     */
    public void setMycontactList(SandboxWebApi.MyContactList[] mycontactList) {
        this.mycontactList = mycontactList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doMyContactResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("mycontactList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "mycontactList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "MyContactList"));
