...
public class DoGetFeedbackResponse  implements java.io.Serializable {
    private SandboxWebApi.FeedbackList[] feedbackList;
    ...
    public DoGetFeedbackResponse(
           SandboxWebApi.FeedbackList[] feedbackList,
           int feedbackCount) {
     ...
     * @return feedbackList
     */
    public SandboxWebApi.FeedbackList[] getFeedbackList() {
        return feedbackList;
    }
     ...
     * @param feedbackList
     */
    public void setFeedbackList(SandboxWebApi.FeedbackList[] feedbackList) {
        this.feedbackList = feedbackList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetFeedbackResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("feedbackList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "feedbackList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FeedbackList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "feedbackCount"));
