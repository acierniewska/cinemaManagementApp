...
public class DoGetFilledPostBuyFormsResponse  implements java.io.Serializable {
    private SandboxWebApi.FilledPostBuyFormsStruct filledPostBuyForms;

    public DoGetFilledPostBuyFormsResponse() {
    }

    public DoGetFilledPostBuyFormsResponse(
           SandboxWebApi.FilledPostBuyFormsStruct filledPostBuyForms) {
     ...
     */
    public SandboxWebApi.FilledPostBuyFormsStruct getFilledPostBuyForms() {
        return filledPostBuyForms;
    }
     ...
     */
    public void setFilledPostBuyForms(SandboxWebApi.FilledPostBuyFormsStruct filledPostBuyForms) {
        this.filledPostBuyForms = filledPostBuyForms;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetFilledPostBuyFormsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filledPostBuyForms");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "filledPostBuyForms"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FilledPostBuyFormsStruct"));
