...
public class DoGetPostBuyFormsDataForBuyersResponse  implements java.io.Serializable {
    private SandboxWebApi.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers;

    public DoGetPostBuyFormsDataForBuyersResponse() {
    }

    public DoGetPostBuyFormsDataForBuyersResponse(
           SandboxWebApi.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers) {
     ...
     */
    public SandboxWebApi.PostBuyFormForBuyersDataStruct[] getPostBuyFormDataForBuyers() {
        return postBuyFormDataForBuyers;
    }
     ...
     */
    public void setPostBuyFormDataForBuyers(SandboxWebApi.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers) {
        this.postBuyFormDataForBuyers = postBuyFormDataForBuyers;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetPostBuyFormsDataForBuyersResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("postBuyFormDataForBuyers");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "postBuyFormDataForBuyers"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PostBuyFormForBuyersDataStruct"));
