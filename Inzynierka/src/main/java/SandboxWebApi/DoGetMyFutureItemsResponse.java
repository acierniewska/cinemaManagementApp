...
public class DoGetMyFutureItemsResponse  implements java.io.Serializable {
    ...
    private SandboxWebApi.FutureItemStruct[] futureItemsList;
    ...
    public DoGetMyFutureItemsResponse(
           ...
           SandboxWebApi.FutureItemStruct[] futureItemsList) {
     ...
     */
    public SandboxWebApi.FutureItemStruct[] getFutureItemsList() {
        return futureItemsList;
    }
     ...
     */
    public void setFutureItemsList(SandboxWebApi.FutureItemStruct[] futureItemsList) {
        this.futureItemsList = futureItemsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMyFutureItemsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("futureItemsCounter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "futureItemsCounter"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("futureItemsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "futureItemsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "FutureItemStruct"));
