...
public class DoGetMessageToBuyerResponse  implements java.io.Serializable {
    private SandboxWebApi.MessageToBuyerStruct messageToBuyer;

    public DoGetMessageToBuyerResponse() {
    }

    public DoGetMessageToBuyerResponse(
           SandboxWebApi.MessageToBuyerStruct messageToBuyer) {
     ...
     */
    public SandboxWebApi.MessageToBuyerStruct getMessageToBuyer() {
        return messageToBuyer;
    }
     ...
     */
    public void setMessageToBuyer(SandboxWebApi.MessageToBuyerStruct messageToBuyer) {
        this.messageToBuyer = messageToBuyer;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">doGetMessageToBuyerResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("messageToBuyer");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "messageToBuyer"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "MessageToBuyerStruct"));
