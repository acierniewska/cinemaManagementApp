...
public class DoGetMySellItemsRequest  implements java.io.Serializable {
    ...
    private SandboxWebApi.SellFilterOptionsStruct filterOptions;
    ...
    public DoGetMySellItemsRequest(
           ...
           SandboxWebApi.SellFilterOptionsStruct filterOptions,
     ...
     */
    public SandboxWebApi.SellFilterOptionsStruct getFilterOptions() {
        return filterOptions;
    }
     ...
     * @param filterOptions
     */
    public void setFilterOptions(SandboxWebApi.SellFilterOptionsStruct filterOptions) {
        this.filterOptions = filterOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", ">DoGetMySellItemsRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "SellFilterOptionsStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
