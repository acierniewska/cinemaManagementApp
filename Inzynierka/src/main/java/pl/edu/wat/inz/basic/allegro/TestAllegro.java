...
public class TestAllegro {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * .getAllegroWebApiPort(); String userLogin = "a_cierniewska"; //
			 * tutaj login allegro String userPassword = "669ce9b035bb44c2"; //
			 * tutaj has³o allegro int countryCode = 1; String webapiKey =
			 * "s669ce9b"; // klucz webapi long localVersion = 1409580573; //
			 * klucz wersji StringHolder sessionHandlePart = new StringHolder();
			 * // tutaj // znajdzie // sie id // sesji po // zalogowaniu
			 * LongHolder userId = new LongHolder(); // tutaj znajdzie sie nasz
			 * // identyfikator LongHolder serverTime = new LongHolder(); //
			 * czas allegro.doLogin(userLogin, userPassword, countryCode,
			 * webapiKey, localVersion, sessionHandlePart, userId, serverTime);
			 * // jesli nie wyskoczy zaden exception, to znaczy, ¿e logowanie
			 * sie // udalo... // to wyœwietlmy kilka danych
			...
			DoGetUserItemsRequest userItems = new DoGetUserItemsRequest(
					userId.intValue(), webkey, country_code, null, null);
